...
class LibraryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        fragmentLibraryBinding.toolbarTitle.setCompoundDrawablesWithIntrinsicBounds(
            null,
            null,
            null,
            null
        )
        fragmentLibraryBinding.toolbarTitle.compoundDrawablePadding =
            resources.getDimensionPixelSize(
                R.dimen.icon_text_padding
            )

        // 텍스트 설정
        fragmentLibraryBinding.toolbarTitle.text = "라이브러리"
